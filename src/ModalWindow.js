      ...
      if (this.props.modalType == "terms" && this.state.accepted == false && this.state.declined == false) {
        return (
          ...
          <h1>Terms and Conditions</h1>
            <p>
              ...
              10. A satisfying sexual relationship[Joking lol ] <br/><br/> 
              11. You didnt need to read any of this, but it was fun making you do so  <br></br>
          </p>
        ...
        return(
          <div className="smallText">
            <p>
              Sighhhh; this is the 4th rejection I'm facing, I give up.
          </p>
          </div>
        );
